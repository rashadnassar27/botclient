      ...
      try {
        if (hubConnection) {
          if (hubConnection.state === "Connected") {
            hubConnection.send(
              "OnClientBotSpeakingStatus",
              audioRef.current.isRunning
            );
            console.log(
              `ClientSpeaking Status sent to server: ${audioRef.current.isRunning}`
            );
          } else {
            console.log(
          ...
          console.log(
            "Cannot send the client bot speaking status due hubConnection is null"
          );
        }
      } catch (error) {
        console.log(error);
...
export default CallWidgetMugan;
